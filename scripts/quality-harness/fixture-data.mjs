...
const groups = {
  ...
  pennsylvania: {
    ...
    image: '/media/groups/twirl-legacy-team.jpg',
    location: 'Saxonburg, PA',
    mobile_detail_url: '/api/v1/mobile/groups/303/',
  },
};
...
const groupDetails = {
  ...
  303: {
    ...
    name: 'Twirl Legacy Team',
    image: '/media/groups/twirl-legacy-team.jpg',
    description: 'A fixture search result used for deterministic groups filtering coverage.',
    website: 'https://example.test/groups/303',
    facebook_page: null,
    creator: null,
    location: 'Saxonburg, PA',
